...
namespace AGPeshawarAPI.Controllers
{
    ...
    {
        [HttpPost]
        [Route("api/Image/ConverttToBaseSF")]
        public IHttpActionResult ConverttToBaseSF([FromBody] UserData value)
        {
            ...
            try
            {
                ...
                value.Signature_pic = StringCompression.Decompress(value.Signature_pic);
